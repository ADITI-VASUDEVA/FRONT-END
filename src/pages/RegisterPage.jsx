    ...
    <div className={styles.registerPage}>
        ...
        <div className={styles.registerationForm}>
          <div className={styles.property1default}>
            ...
            <div className={styles.credentialsParent}>
              ...
              <div className={styles.credentials}>
                <div className={styles.username}>
                  <div className={styles.inputTextLabel}>password</div>
                  <div className={styles.inputField}>
                    <div className={styles.text1}>
              ...
              <div className={styles.credentials}>
                <div className={styles.username}>
                  <div className={styles.inputTextLabel}>Confirm Password</div>
                  <div className={styles.inputField}>
                    <div className={styles.text1}>
                      <div className={styles.typeHere}>Enter username</div>
                      <img className={styles.icon} alt="" />
            ...
            <div className={styles.tandc}>
              <div className={styles.text7}>Agree to terms and conditions</div>
              <img className={styles.checkboxIcon} alt="" src="/checkbox.svg" />
            </div>
            <b className={styles.logo1}>rEGISTER</b>
          </div>
        </div>
      </div>
      <div className={styles.error}>
        ...
        <div className={styles.buttonSecondary}>
          <div className={styles.background2} />
          <div className={styles.text8}>Get Started</div>
        </div>
      </div>
